...
export function ContactForm() {
  ...
  const inputClass =
    "w-full rounded-lg border border-accent/30 bg-navy-light/50 backdrop-blur-sm px-4 py-3 text-white placeholder-gray-500 transition-all focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/50 focus:bg-navy-light";
