...
const WHATSAPP_MESSAGE =
  "Hi, I'm interested in firearm training at Steadfast Tactical. Could you please provide more information?";
...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] py-3.5 pl-4 pr-5 text-white shadow-[0_16px_44px_-10px_rgba(37,211,102,0.7)] transition-colors duration-300 hover:bg-[#20BA5A] md:py-4"
    ...
    >
      ...
      <span className="pointer-events-none absolute inset-0 rounded-full" aria-hidden>
        <span className="absolute inset-0 animate-ping rounded-full bg-[#25D366] opacity-30" style={{ animationDuration: "2.6s" }} />
      </span>
