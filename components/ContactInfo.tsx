  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group flex items-center gap-4 p-4 bg-[#0d1117]/50 border border-[#25D366]/30 transition-all hover:border-[#25D366]/50 hover:bg-[#0d1117] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#0a0a0a]"
      >
